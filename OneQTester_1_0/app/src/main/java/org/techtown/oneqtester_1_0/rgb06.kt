...
class rgb06 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rgb06)
        rgb_6_b1.setBackgroundColor(Color.BLUE)
        var val1 = intent.getStringExtra("answer1")
        rgb_6_b1.setOnClickListener { view->
            var intent = Intent(this,rgb07::class.java)
