...
import kotlinx.android.synthetic.main.activity_proximity02.*

class proximity02 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_proximity02)

        var val1 = intent.getStringExtra("answer1")
        var val2 = intent.getStringExtra("answer2")
        var val3 = intent.getStringExtra("answer3")

        step4_2_b1.setOnClickListener { view->
            var intent = Intent(this,proximity03::class.java)
